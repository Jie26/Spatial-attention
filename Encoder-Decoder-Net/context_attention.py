...
#Decoder structure
    ...
    class Decoder(nn.Module):
        def __init__(self, decoder_input_dim,emb_dim, hid_dim, n_layers, dropout=0.2):
            ...
            self.attn = nn.Linear(self.hid_dim +self.emb_dim, hid_dim)
    #         self.attn_combine = nn.Linear(self.hidden_size+self.de_emb_dim , self.hidden_size)
        ...
        def forward(self, input,context, hidden, cell):
            ...
            #add a dimension in the first position
    ...
    #         attn_weights=F.softmax(attn,dim=2)
            ...
            context=torch.mul(context,attn_weights)
            #print(context.shape)
    ...
    class Seq2Seq(nn.Module):
        ...
        def forward(self, x, y, teacher_forcing_ratio = 0.5):
            ...
            outputs = torch.zeros(max_len, batch_size, out_size)
    ...
    print('this is context-attention\n')
    for epoch in range(N_EPOCHS):
        ...
        if test_loss<2.1:
            ...
            np.save(r'./result/context_attn_predict_tra.npy',test_result)
