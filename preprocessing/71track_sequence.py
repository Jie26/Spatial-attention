...
position_output=position_output[:j,:,:]
label_output=label_output[:j,:,:]
np.save(r'/usr/stud/wangx0/storage/slurm/JieW/highd1/data_sqe1/6track_input.npy',track_input)     
np.save(r'/usr/stud/wangx0/storage/slurm/JieW/highd1/data_sqe1/6position_output.npy',position_output)
np.save(r'/usr/stud/wangx0/storage/slurm/JieW/highd1/data_sqe1/6label_output.npy',label_output)
