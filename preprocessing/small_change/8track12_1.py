...
base_path1 = r'/usr/stud/wangx0/storage/slurm/JieW/highd1/7_non-exist61'
...
#np.save(r'/usr/stud/wangx0/storage/slurm/JieW/highd1/#data_sqe5/6track_input.npy',track_input)     
#np.save(r'/usr/stud/wangx0/storage/slurm/JieW/highd1/#data_sqe5/6position_output.npy',position_output)
#np.save(r'/usr/stud/wangx0/storage/slurm/JieW/highd1/#data_sqe5/6label_output.npy',label_output)
