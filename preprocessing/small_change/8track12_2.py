...
base_path1 = r'/usr/stud/wangx0/storage/slurm/JieW/highd1/7_non-exist41'
...
#np.save(r'/usr/stud/wangx0/storage/slurm/JieW/highd1/#data_sqe6/4track_input.npy',track_input)     
#np.save(r'/usr/stud/wangx0/storage/slurm/JieW/highd1/#data_sqe6/4position_output.npy',position_output)
#np.save(r'/usr/stud/wangx0/storage/slurm/JieW/highd1/#data_sqe6/4label_output.npy',label_output)
